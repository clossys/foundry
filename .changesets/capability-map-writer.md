...
for the rest pending dedicated per-capability cases (#1272). Drafted per
#1200, checked by `check-capability-maps.mjs` for its own mechanical
MECE criteria (no duplicate outputs or sub-questions within a role, no
