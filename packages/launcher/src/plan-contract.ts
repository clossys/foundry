...
/** Every reason a plan is refused: the plan contract's schema, then, once that passes, its code rules R1-R9. */
 ...
 * its schema, then, once that passes, its code rules R1-R9 -- staffing and
