...
/** Every reason a plan is refused: the plan contract's schema, then, once that passes, its code rules R1-R8. */
 ...
 * its schema, then, once that passes, its code rules R1-R8 -- staffing and
