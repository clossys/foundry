...
console.log(`pack-skills: wrote the plan, brief, inventory, registry snapshot, change-set and bundle contracts, the contract checker copy, and the publishing scope and registry into src/generated/`);
