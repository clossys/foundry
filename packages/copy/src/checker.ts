 ...
 * `@vespeneventures/copy/voice`'s own `checkCopy`, against a single
 * `VoiceRecord`, and reports the result. This is the one file in this
 * package that imports `@vespeneventures/copy/voice`: `types.ts` and
 ...
 * `@vespeneventures/copy/voice`'s README, "The `factRef` seam".
 */
