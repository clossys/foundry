 ...
 * `@vespeneventures/voice`'s own `checkCopy`, against a single
 * `VoiceRecord`, and reports the result. This is the one file in this
 * package that imports `@vespeneventures/voice`: `types.ts` and
 ...
 * `@vespeneventures/voice`'s README, "The `factRef` seam".
 */
