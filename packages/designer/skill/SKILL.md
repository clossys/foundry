...
3. **Customer inhabit** — independent `@clossys-customer` session. First-person keep of the named Audience, not a checklist. That person can also be asked for lived feedback, comparison from their consideration set, referral, and churn. Do not run that session as Designer.
