...
```bash
npx designer-brand-check src/styles/brand.css
```

`designer-brand-check` wires `readBrandCss` and `checkBrandFileCoverage` together
...
`npx designer-brand-check --help` for the full usage.
