...
export interface RenderImageOptions {
   ...
   * `CopyLookup` shape `@vespeneventures/surface/core`'s own `resolveCopy` takes
   ...
   * `AssetLookup` shape `@vespeneventures/surface/core`'s own `resolveAssets`
   ...
   * own values instead of `@vespeneventures/ui/tokens`' defaults. Omit to use
