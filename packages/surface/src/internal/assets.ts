 ...
 * `@vespeneventures/surface/media` to get it. Same "opaque seam, not a code
 * import" reasoning `@vespeneventures/surface/core`'s own `resolve-assets.ts`
 * gives for `AssetLookup` itself: `@vespeneventures/surface` works whether
 * or not `@vespeneventures/surface/media` is even installed, and a caller with a
 ...
 * not `@vespeneventures/surface/media`' own `licence`/`credit` — those are
 ...
 * -------------------------------------------------------------------------------
 * `@vespeneventures/surface/media`' own `AssetEntry.alt` doc comment: "there is no
 ...
 * structurally the same shape `@vespeneventures/surface/media`' `AssetEntry`
 ...
 * library, the same discipline `@vespeneventures/surface/media`' own `schema.ts`
