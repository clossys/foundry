 ...
 * `@vespeneventures/ui/tokens` -> literal-color flattening every channel
 ...
 *     `channel: "print"` document. `@vespeneventures/surface/core`'s own frozen
 ...
 *     token role absent from `@vespeneventures/ui/tokens`' `TOKENS` registry
