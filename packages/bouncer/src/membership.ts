...
function nextCursor(
  ...
  return {
    ...
    // An unversioned delivery must not erase a provider sequence already
    // observed for this identity. Otherwise a later old, versioned delivery
    // could bypass version ordering through timestamp comparison.
