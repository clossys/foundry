 ...
 * `@vespeneventures/assets` `checkAssetCoverage`-style lookup, or any
 ...
 * import of `@vespeneventures/assets`'s `AssetEntry` — see "Why this
 ...
 * back a full `@vespeneventures/assets` `AssetEntry`, a bare URL string, a
 ...
 * `@vespeneventures/assets` itself — see the README, "Zero runtime
 ...
 */
export function resolveAssets(result: ResolveResult, lookup: AssetLookup): AssetResolveResult {
