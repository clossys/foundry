...
import { buildGeometryWarnings, buildSyntheticLayout, orderEntries } from "./geometry.js";
import type { GeometryEntry } from "./geometry.js";

describe("buildSyntheticLayout", () => {
  it("builds one flowed slot per distinct binding.slot in first-occurrence order", () => {
...
describe("orderEntries", () => {
  ...
  it("is stable when legacy positioned entries tie", () => {
    const entries: GeometryEntry[] = [
      { key: "first", frame: { x: 0, y: 0, w: 1, h: 1 }, text: "t", element: "body" },
      { key: "second", frame: { x: 0, y: 0, w: 1, h: 1 }, text: "t", element: "body" },
      { key: "third", frame: { x: 0, y: 0, w: 1, h: 1 }, text: "t", element: "body" },
    ];
