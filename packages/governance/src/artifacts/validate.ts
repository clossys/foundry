 ...
 * `@vespeneventures/policy`'s own `validateBindingShape` (via a small
...
import type { DigestAlgorithm, Finding } from "@vespeneventures/policy";
 ...
 * again. This mirrors `@vespeneventures/policy`'s own `verifyBinding`,
