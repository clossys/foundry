 ...
 *    sound is exactly the precondition mistake `@vespeneventures/policy`'s
 ...
 *    `@vespeneventures/policy`'s `verifyBinding` — no hashing and no digest
 ...
 * (matching `@vespeneventures/policy`'s own `computeDigest` contract). This
