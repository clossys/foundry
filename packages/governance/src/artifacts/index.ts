/**
 * `@vespeneventures/governance/artifacts` — a reusable contract for
...
// Re-exported so a consumer of this subpath never needs a direct dependency
// on @vespeneventures/policy just to type a Finding or hand-build a
// PolicyBinding — matching how ../gates/index.ts re-exports the same pair.
export type { DigestAlgorithm, Finding, PolicyBinding } from "@vespeneventures/policy";
