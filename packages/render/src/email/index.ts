/**
 * @vespeneventures/render/email — the `email` channel renderer. Takes a
 ...
 * `@vespeneventures/render/email` has NO extra peer dependencies beyond
 * this package's own real dependencies (`@vespeneventures/compose`,
 * `@vespeneventures/tokens`). A consumer who only imports this subpath
