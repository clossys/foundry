...
- `foundry.capabilities` (schema v3, issue #1196): a MECE capability map of
  ...
  genuinely proven only for `keep-verdict`, cited as a disclosed anchor
  for the rest pending dedicated per-capability cases (#1272). Drafted per #1201, checked by `check-capability-maps.mjs` for its own
