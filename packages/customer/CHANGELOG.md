...
- Packed skill: speak only from the audience `situation` and `pains`
  Strategist recorded — do not author the audience record. Do not inhabit
  until `strategist-check handoff` would be green on the strategy
  directory. Refs: #1122.
