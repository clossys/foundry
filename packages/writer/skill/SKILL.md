...
3. **Customer inhabit** — independent `@clossys-customer` session. First-person keep of the named Audience, not a checklist. That person can also be asked for lived feedback on any topic, comparison from their consideration set, what it would take to start or to refer, whether it is worth what it costs them, and what would make them leave. Do not run that session as Writer.
