...
Done is exceptional (5) as defined in Designer `PRE-AUTH-QUALITY.md`. `designer-hero-css-check`, `designer-fold-check`, and `writer-check --live` prove 3 only — never call 3 done or world class. A 5 keep is independent QA inhabited as the named Strategist Audience, comprehensive, not a copy score. This role does not author keep-review evidence and does not inhabit the persona.
