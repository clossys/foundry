 ...
 * gets compared to content, because `@vespeneventures/policy` already owns
 ...
 * expectedDigest }` — and calls `@vespeneventures/policy`'s own `verifyBinding`
 ...
 * concern, the same way `@vespeneventures/policy` never reads a file itself.
 */
