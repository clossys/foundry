...
3. **Customer inhabit** — independent `@clossys-customer` session. First-person keep of the named Audience, not a checklist. They may also be asked for lived feedback, comparison from their consideration set, referral, and churn. You do not speak as them.
