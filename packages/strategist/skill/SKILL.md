...
3. **Customer inhabit** — independent `@clossys-customer` session. First-person keep of the named Audience this role recorded, not a checklist. They may also be asked for lived feedback on any topic, comparison from their consideration set, what it would take to start or to refer, whether it is worth what it costs them, and what would make them leave. Strategist supplies the persona source and does not inhabit it.
