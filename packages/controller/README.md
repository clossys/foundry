...
`InstalledPositionLedgerReport` (its `advisories` field is additive: it never
changes `ok`, `findings`, `openRoles`, or `positions`, and is how a legacy
0.9.10 ledger's accepted migrations are reported),
