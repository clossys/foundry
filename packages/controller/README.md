...
Reference safety is a lexical backstop, not a secret scanner: after bounded
percent decoding plus NFKC, case, invisible-character, and form-style `+`
