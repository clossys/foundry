 ...
 * (see that file's own header for the parity rationale — this package's
 * one guard site, `secret-gates.ts`, reads `typescript`'s own exported
 * `ts.version` instead and does not currently call this function).
 */
