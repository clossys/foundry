...
export const REFERENCE_VALUE_RULE = "Evidence references and locators reject explicit inline credential, provider-value, and central-adoption-decision payload assignments and actual URL authority userinfo under three bounded 65,536-code-unit normalization layers, literal-delimiter parsing in preserved and TAB/CR/LF-stripped views, standalone root-atom and query/fragment-value candidate scope, and scalar-projected path/opaque protection; this lexical check neither authenticates a pointer nor proves every secret absent.";
