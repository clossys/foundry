...
export {
  REPOSITORY_PACKAGE_ADOPTION_COVERAGE,
  REPOSITORY_PACKAGE_ADOPTION_EVENT_KINDS,
  REPOSITORY_PACKAGE_ADOPTION_REASONS,
  REPOSITORY_PACKAGE_ADOPTION_VERSION,
...
export type {
  ...
  RepositoryPackageAdoptionEventKind,
  RepositoryPackageAdoptionFinding,
  RepositoryPackageAdoptionFindingRule,
