...
describe("public role boundary", () => {
  it("ships mapped bins without a leading ./, zero runtime dependencies, and no provider adapter surface", () => {
    ...
    expect(manifest.bin).toEqual({
      "influencer-check": "dist/cli.js",
      "influencer-rate-check": "dist/qualified-response-yield-cli.js",
    });
