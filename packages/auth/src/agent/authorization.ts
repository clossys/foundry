...
/**
 * Requires a current, scoped delegated authority before a tool call proceeds.
 *
 * A malformed or absent context is denied. This function deliberately has no
 * fallback behavior because it is intended to guard privileged actions.
 */
...
/**
 * Requires both tool authority and monetary authority for one requested amount.
 *
 * A null limit represents unlimited amount authority, never unlimited lifecycle
 * or tool authority: `assertAgentCanCall` always runs first.
 */
