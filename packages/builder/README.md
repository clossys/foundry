...
Node.js >= 20, ESM. Runtime dependency: `@vespeneventures/controller` (`~0.5.0`), for the `GateResult` ternary the `liveStateSurface` and CI-mechanics modules build on rather than reinvent.
