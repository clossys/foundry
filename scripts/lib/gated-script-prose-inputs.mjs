...
export const GATED_SCRIPT_PROSE_INPUTS = {
  ...
  "node:scripts/lib/import-purity.test.mjs": { prose: false, reason: "import-purity checker tests on synthetic TypeScript sources it writes to a temporary directory; reads no docs/ or .changesets/ path" },
