...
const findings = [
  ...
  ...validateAggregateV2RecordSets({
    closureRecords: aggregateV2RecordPaths({ root, directory: AGGREGATE_V2_CLOSURE_DIRECTORY }),
    transcriptRecords: aggregateV2RecordPaths({ root, directory: AGGREGATE_V2_TRANSCRIPT_DIRECTORY }),
  }),
];
for (const [directory, records] of [[AGGREGATE_V2_CLOSURE_DIRECTORY, aggregateV2RecordPaths({ root, directory: AGGREGATE_V2_CLOSURE_DIRECTORY })], [AGGREGATE_V2_TRANSCRIPT_DIRECTORY, aggregateV2RecordPaths({ root, directory: AGGREGATE_V2_TRANSCRIPT_DIRECTORY })]]) {
