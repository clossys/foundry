...
/**
 * The always-on finding for a package that classified as "unclassified" or
 * "both" -- a defect the gates report in every mode, never only under
 * --enforce, because a classification gap is not an adoption gap. Returns
 * null for "role" and "tooling", which are not findings.
 */
