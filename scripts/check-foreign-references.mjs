...
const PLACEHOLDER_NAMES = new Map([
  ...
  ["catalog-fixture", "packages/governance catalog test fixtures"],
  ["gates-fixture", "packages/governance gate test fixtures"],
  ["gates-cli-fixture", "packages/governance gate CLI test fixtures"],
  ...
  ["x", "single-letter stand-in in packages/governance catalog tests"],
