...
function makeIdentityTransitionFixture(root) {
  ...
  const catalog = {
    ...
    targets: [
      ...
      { id: candidate.releaseTarget, status: "active", scope: candidate.scope, registry: candidate.registry, access: candidate.access, packages: ["advisor", "starter", "controller", "designer"] },
    ],
  };
  const lifecycle = {
    schemaVersion: 1,
