...
| [`@vespeneventures/governance`](packages/governance) | The package-process authority: lifecycle records and no-write starter planning at its root; workspace catalog, gates, release proof, repository profiles, review evidence, and a pure workspace-cleanup classifier at focused subpaths. |
